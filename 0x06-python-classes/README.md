...
This project entails using Python classes and object to write scripts on object-oriented programming paradigm. I learned about attributes, methods, and properties as well as data abstraction, data encapsulation, and information hiding.
